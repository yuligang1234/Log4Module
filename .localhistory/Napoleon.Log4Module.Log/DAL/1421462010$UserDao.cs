...
namespace Napoleon.Log4Module.Log.DAL
{
    public static class UserDao
    {
        ...
        public static DataTable SelectLog(this SystemLog log, string startTime, string endTime, int rows, int page)
        {
        ...
        {
            string sql = string.Format("select countcount(*) from dbo.System_Log");
            DataTable dt = SqlHelper.GetDataTable(sql);
            if (dt.Rows.Count > 0)
            {
