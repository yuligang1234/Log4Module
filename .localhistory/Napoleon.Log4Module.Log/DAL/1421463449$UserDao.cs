...
namespace Napoleon.Log4Module.Log.DAL
{
    public static class UserDao
    {
        ...
        public static DataTable SelectLog(SystemLog log, string startTime, string endTime, int startCount, int endCount)
        {
        ...
        public static int LogCount(SystemLog log, string startTime, string endTime)
        {
